...
namespace Acrelec.Mockingbird.Payment_ROI_LANE3000
{
    ...
    public class Communicator
    {
        ...
        /// </summary>
        private const string PAY_APPLICATION_PIPE_SERVER_NAME = "ROI_LANE3000_ExePipeServer";
        ...
        /// </summary>
        private const string CORE_PIPE_SERVER_NAME = "ROI_LANE3000_CorePipeServer";
        #endregion
        ...
        public bool SendMessage(CommunicatorMethods method, object parameters)
        {
            ...
            if (pipeClient.SendMessage(PAY_APPLICATION_PIPE_SERVER_NAME, message))
            {
