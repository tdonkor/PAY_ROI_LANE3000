...
namespace Acrelec.Mockingbird.Payment_ROI_LANE3000
{
    [Export(typeof(IPayment))]
    public class Payment_ROI_LANE3000 : IPaymentCard, ICommunicatorCallbacks
    {
        private const string PAYMENT_ID = "372002";

        private const string PAYMENT_LOG = "Payment_ROI_LANE3000";

        private const string PAYMENT_NAME = "ROI_LANE3000";

        private const string PAYMENT_APPLICATION_NAME = "PAY_ROI_LANE3000.exe";

        private const string PAYMENT_APPLICATION_PROCESS_NAME = "PAY_ROI_LANE3000";
        ...
        public Payment_ROI_LANE3000(ILogger logger = null)
        {
            this.logger = logger;
